...
export function VehicleForm({ vehicle }: { vehicle?: Vehicle | null }) {
  return (
    <form action={saveVehicleAction} className="panel form-grid" encType="multipart/form-data">
      ...
      <div className="field"><label>Year</label><input name="year" type="number" defaultValue={vehicle?.year ?? new Date().getFullYear()} required /></div>
      ...
      <div className="field"><label>Mileage (km)</label><input name="mileage" type="number" defaultValue={vehicle?.mileage ?? ""} /></div>
      ...
      <div className="field"><label>Seats</label><input name="seats" type="number" defaultValue={vehicle?.seats ?? 5} /></div>
      ...
      <div className="field"><label>Sale price (KSh)</label><input name="sale_price" type="number" defaultValue={vehicle?.sale_price ?? ""} /></div>
      <div className="field"><label>Daily rate (KSh)</label><input name="daily_rate" type="number" defaultValue={vehicle?.daily_rate ?? ""} /></div>
      <div className="field"><label>Weekly rate (KSh)</label><input name="weekly_rate" type="number" defaultValue={vehicle?.weekly_rate ?? ""} /></div>
      <div className="field"><label>Monthly rate (KSh)</label><input name="monthly_rate" type="number" defaultValue={vehicle?.monthly_rate ?? ""} /></div>
      ...
      <div className="field"><label>Vehicle photo</label><input name="image" type="file" accept="image/jpeg,image/png,image/webp" /></div>
